            ...
            int[,] grid = new int[20, 20]
{
            ...
            while (d != 20)
            {
                ...
                for (i = 0; i < 20; i++)
                {
                    int sum = grid[a, i] * grid[b, i] * grid[c, i] * grid[d, i];
                    int n = 0;
                    if (n < sum)
                    { n = sum; highest[0] = n; }
                }
            ...
            while (d != 20)
            {
                ...
                for (i = 0; i < 20; i++)
                {
                    int sum = grid[i, a] * grid[i, b] * grid[i, c] * grid[i, d];
                    int n = 0;
                    if (n < sum)
                    { n = sum; highest[1] = n; }
                }
            ...
            a = 0; b = 1; c = 2; d = 3;
            int e = 0; int f = 1; int g = 2; int h = 3;
            ...
            while (d != 20)
            {
                while (h != 20)
                {
                    int sum = grid[a, e] * grid[b, f] * grid[c, g] * grid[d, h];
                    int n = 0;
                    if (n < sum)
                    { n = sum; highest[2] = n; }
                    e++; f++; g++; h++;
